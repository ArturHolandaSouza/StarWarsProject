    ...
    try {
        ...
        responseJson.results.forEach((character) => {
            ...
            card.onclick = () => {
                ...
                cost.innerText = `Custo em Creditos: ${character.cost_in_credits}`;

                const passengers = document.createElement('span');
                passengers.className = 'character-details';
                passengers.innerText = `Numero de passageiros: ${character.passengers}`;

                const starshipClass = document.createElement('span');
                starshipClass.className = 'character-details';
                starshipClass.innerText = `Classe: ${character.starship_class}`;
